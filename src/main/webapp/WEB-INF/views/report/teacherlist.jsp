                        ...
                        <div class="content-wrapper">
                            <div class="row">                                
                                <div class="col-12 grid-margin float-right stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Teacher Report</h4>
                                        <form:form method="POST" class="form-inline" commandName="teacherInputForm" action="teacherView">

                                            <div class="input-group mb-2 mr-sm-2">

                                                <form:input class="form-control" placeholder="Enter Teacher Name"  path="tname" id="title"/>
                                            </div>
