                            ...
                            <div class="row">                                
                                <div class="col-12 grid-margin float-right stretch-card">
                                    <div class="card">
                                        ...
                                        <form:form method="POST" class="form-inline" commandName="reportInputForm" action="sudentView">

                                            <div class="input-group mb-2 mr-sm-2">

                                                <form:input class="form-control" placeholder="Enter Class Name" name="startdate" path="classid" id="title"/>
                                            </div>


                                            <div class="input-group mb-2 mr-sm-2">
                                                <form:input class="form-control" placeholder="Enter Section Name" name="enddate" path="secid" id="title"/>
