                            ...
                            <div class="row">                                
                                <div class="col-12 grid-margin float-right stretch-card">
                                    <div class="card">
                                        ...
                                        <form:form method="POST" class="form-inline" commandName="attendenceInputForm" action="attendenceView">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                <form:input class="form-control" placeholder="Enter Attendence Date" name="atdate" path="atdate" id="title"/>
