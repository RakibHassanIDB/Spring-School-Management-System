<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="${pageContext.request.contextPath}/addexammark">
                <i class="mdi mdi-database menu-icon"></i>
                <span class="menu-title">Add Exam Mark</span>
            </a>
        </li>
<!--        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="showexammarkpage">Exam Marks</a></li>
                    ...
                    <li class="nav-item"> <a class="nav-link" href="showingsubjectpage">Subjects</a></li>
